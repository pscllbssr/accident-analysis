...
For plotting and background checks we also load the street-network of swiss motorways. This is a geodata-set including geographical ubications of all national roads in Switzerland and corresponding attributes like name, etc.   
...
## interpreting the regression model... (I just think we need to add some interpretation in 2-3 sentences as in statistics)
...
This is significant at ... blablabla ... for every nth car passing there is an accident... blablabla.
